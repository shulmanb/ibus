...
public class SubmapIdGeneratorTest {
	...
	@Test
	public void testGetSubmapIdForPoint_LastSquare_belowEquator() {
		SubmapIdGenerator idg = new SubmapIdGenerator(new Point(-30,0),new Point(-29,-1), 5, "ID");
		String id = idg.getSubmapIdForPoint(new Point(-29,-1));
		assertEquals("ID_"+22*22, id);
		//lat long distances at 0 in meters: 110570,111320
	}
	@Test
	public void testGetSubmapIdForPoint_FirstSquare_belowEquator() {
		SubmapIdGenerator idg = new SubmapIdGenerator(new Point(-30,0),new Point(-29,-1), 5, "ID");
		String id = idg.getSubmapIdForPoint(new Point(-30,0));
		assertEquals("ID_"+1, id);
		//lat long distances at 0 in meters: 110570,111320
	...
	@Test
	public void testGetSubmapIdForPoint_FirstLineMiddleSquare_belowEquator() {
		SubmapIdGenerator idg = new SubmapIdGenerator(new Point(-30,0),new Point(-29,-1), 5, "ID");
		String id = idg.getSubmapIdForPoint(new Point(-29.5,0));
		assertEquals("ID_"+12, id);
		//lat long distances at 0 in meters: 110570,111320
	}
}
